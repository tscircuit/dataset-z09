...
const getNodeWithPortPoints = (
  sample: (typeof firstHundredDatasetSampleEntries)[number]["sample"],
): NodeWithPortPoints => ({
...
export default function DatasetPage() {
  ...
  const firstDatasetEntry = firstHundredDatasetSampleEntries[0];

  if (firstHundredDatasetSampleEntries.length === 0) {
    return (
      <div
        style={{
          minHeight: "100vh",
  ...
  const currentEntry =
    firstHundredDatasetSampleEntries[selectedIndex] ?? firstDatasetEntry;
  const currentSample = currentEntry?.sample;
        ...
        >
          ...
          >
            <div style={{ display: "grid", gap: 10 }}>
              ...
              >
                The dataset debugger is limited to the first 100 samples.
                Deterministic synthetic nodes are annotated with `solvable`
                using `HyperSingleIntraNodeSolver`, and the debugger defaults
                to that same solver.
              </p>
            </div>
